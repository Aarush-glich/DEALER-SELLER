      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <h1 className="font-heading font-extrabold text-4xl text-slate-900 dark:text-white leading-tight">
            Pioneering Sourcing Transparency in Coated Steel and Building Solutions
          </h1>
          <p className="text-slate-600 dark:text-slate-400 font-light leading-relaxed">
            Tata Steel Colors, evolved from Tata BlueScope Steel, serves India with coated steel, roofing and wall cladding, smart building systems, solar mounting solutions, and pre-engineered building solutions.
          </p>
          <p className="text-slate-600 dark:text-slate-400 font-light leading-relaxed">
            This digital procurement gateway represents our initiative to make vendor sourcing auditable, transparent, and fair across COLORBOND, ZINCALUME, LYSAGHT, DURASHINE, EZYBUILD, ECOBUILD, and ILIOS supply categories.
          </p>
        </div>
        ...
        <div className="relative flex justify-center">
          <div className="w-full max-w-[28rem] aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl relative border border-slate-200 dark:border-slate-800 bg-slate-900">
            ...
            <div className="absolute bottom-6 left-6 z-20 space-y-1">
              <span className="text-[10px] tracking-[0.2em] font-semibold text-tata-300 uppercase">Coated Steel Supply Chain</span>
              <span className="block font-heading font-bold text-white text-lg">Roofing, Cladding and Building Products Network</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="pt-12 border-t border-slate-200/50 dark:border-slate-800/50 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-white/40 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800/50 space-y-2">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Dedicated sourcing and procurement panels review comparisons and issue work orders within 24 hours of tender closing.
            </p>
          </div>
          <div className="p-6 rounded-2xl bg-white/40 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800/50 space-y-2">
            <span className="block font-bold text-slate-900 dark:text-white">4. Local Partnerships</span>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              Support domestic steel processors, roll-forming partners, fastener suppliers, and building-product fabricators under local sourcing schemes.
            </p>
          </div>
        </div>
      </div>
